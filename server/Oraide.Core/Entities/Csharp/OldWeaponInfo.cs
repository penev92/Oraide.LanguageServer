namespace Oraide.Core.Entities.Csharp
{
	...
	/// </summary>
	public readonly struct OldWeaponInfo
	{
		...
		public OldWeaponInfo(ClassFieldInfo[] weaponPropertyInfos, SimpleClassInfo[] projectileInfos, SimpleClassInfo[] warheadInfos)
		{
